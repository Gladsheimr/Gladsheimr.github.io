...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.dfd509610d194d8221d57812841a87c5ef0376e2a4199d114e0858ebacd8c6a8.js',function(){input.required=false;search();});}
