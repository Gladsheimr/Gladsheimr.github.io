...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.d3dad343e48b9d3d1d7c42ddabfd48f28bbf0bbd1bdf639886ed6dd48765539e.js',function(){input.required=false;search();});}
