...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.203aa8905fe79536652a40d69f864c0755b2edcbbd6489fcf6e4de250b61bee3.js',function(){input.required=false;search();});}
