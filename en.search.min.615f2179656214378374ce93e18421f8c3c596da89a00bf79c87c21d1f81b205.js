...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c889ee4063e76a3d32caf93dd7b102829755099525ee8a8040d06b8e3e28ea3b.js',function(){input.required=false;search();});}
